class ImageConstants {
  ...
  static const String backgroundRoot = "./assets/images/background/";

  //icons
  static const String buttonGradient = "${iconsRoot}button_gradient.png";
  ...
  //background
  static const String splashScreen = "${backgroundRoot}splash.png";
}
